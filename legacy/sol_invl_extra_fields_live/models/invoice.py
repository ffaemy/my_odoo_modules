...
class AccountInvoiceLine(models.Model):
    ...
    @api.onchange('product_id','tp_rate_value','price_unit','dist_margin_unit','trade_offer_amount' ,'trade_offer','quantity', 'ctn','retail_price_per_ctn', 'dist_margin_ctn','ctn_packing', 'dist_margin','trade_offer_amount')
